...
const toCssUnit = (value: number | string | undefined) => (typeof value === 'number' ? `${value}px` : value);

const resolveCharset = (charset: string | undefined) => {
...
const normalizePhrase = (phrase: string | undefined, width: number) => {
